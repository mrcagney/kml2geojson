...
def test_convert():
    ...
    # Try again without separating folders
    get_list = convert(kml_path, style_type="svg", separate_folders=False)
    ...
    # Try again without separating folders and without a style file
    get_list = convert(kml_path, separate_folders=False)
    for i in range(len(get_list)):
